...
- [Sleep-EEG staging evaluation](https://github.com/viranovskaya/sleep-eeg-staging-evaluation) — comparison of YASA predictions with expert annotations across 20 Sleep-EDF recordings, including recording-level uncertainty and edge-Wake sensitivity. The current release is [archived on Zenodo](https://doi.org/10.5281/zenodo.21354517).
