...
- MNE-Python documentation and tests for [OpenBLAS threads](https://github.com/mne-tools/mne-python/pull/14064) and [docstring parameter types](https://github.com/mne-tools/mne-python/pull/14100).
...
- [Draft validation for complete BrainVision file triplets](https://github.com/bids-standard/bids-specification/pull/2501).
